...
public class CloseSessionView {
	...
	public void Cerrar() {
		...
		panelBtnCerrarSesion.setBounds(296, 235, 289, 40);
		...
		btnCerrarSesion1.setBounds(0, 0, 289, 40);
		panelBtnCerrarSesion.add(btnCerrarSesion1);
		btnCerrarSesion1.setForeground(Color.WHITE);
		btnCerrarSesion1.setFont(new Font("Calibri", Font.BOLD, 19));
		btnCerrarSesion1.setFocusPainted(false);
		btnCerrarSesion1.setContentAreaFilled(false);
		btnCerrarSesion1.setBorderPainted(false);
		btnCerrarSesion1.setBackground(new Color(55, 104, 167));

		btnCerrarSesion1.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        int confirm = JOptionPane.showConfirmDialog(frame, "¿Está seguro de que desea cerrar sesión?", "Confirmar cierre de sesión", JOptionPane.YES_NO_OPTION);
		...
		lblTituloContenido.setHorizontalAlignment(SwingConstants.CENTER);
		lblTituloContenido.setBounds(160, 129, 557, 74);
		panelcontenedor.add(lblTituloContenido);
		lblTituloContenido.setFont(new Font("Calibri", Font.PLAIN, 40));
